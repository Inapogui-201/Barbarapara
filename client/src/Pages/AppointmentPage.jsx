...
const CustomCalendar = ({ onDateSelect }) => {
  ...
  const handleDateSelect = (day) => {
    if (day) {
      ...
      if (!isDateDisabled(selectedDate.getFullYear(), selectedDate.getMonth(), day)) {
      ...
      <div className="p-4">
                ...
                <div className="absolute top-full left-0 mt-1 bg-white border rounded-lg shadow-lg z-10">
                  {months.map((month, index) => (
                    <button
                      key={month}
                      onClick={() => {
                        const newDate = new Date(selectedDate.getFullYear(), index);
                        if (newDate >= today) {
                          setSelectedDate(newDate);
                      ...
                      disabled={new Date(selectedDate.getFullYear(), index) < today}
                    >
                      {month}
                    </button>
                  ))}
        ...
        <div className="grid grid-cols-7 gap-2">
          ...
          {generateCalendarDays().map((day, index) => {
            const isDisabled = day && isDateDisabled(selectedDate.getFullYear(), selectedDate.getMonth(), day);
            const isSelected = day === selectedDate.getDate() && 
                             !isDateDisabled(selectedDate.getFullYear(), selectedDate.getMonth(), day);
            ...
            return (
              <div
                ...
                className={`
                  text-center py-2 ${day ? 'cursor-pointer' : ''}
                  ${isDisabled ? 'text-gray-300 cursor-not-allowed' : day ? 'hover:bg-gray-100' : ''}
...
const AppointmentScheduler = () => {
  ...
  const serviceTypes = [
    ...
    { value: 'EMDR', label: 'Désensibilisation et retraitement par les mouvements oculaires' },
  ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">N° et rue</label>
                    <input
                      type="text"
                      name="streetAddress"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Ligne d'adresse additionnelle</label>
                    <input
                      type="text"
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">État/Région</label>
                      <input
                        type="text"
                        name="region"
                        className="w-full p-3 border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-gray-800 focus:border-gray-800 outline-none transition-all"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-3">Nous avez-vous déjà rendu visite ?</label>
              ...
              <div className="space-y-6">
                <h3 className="text-lg font-semibold text-gray-800 border-b pb-2">Détails du Rendez-vous</h3>
                ...
                <div className="rounded-xl p-6 space-y-6 bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 shadow-lg">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <h3 className="text-lg font-medium text-gray-800">Date du rendez-vous*</h3>
                    </div>
                    <CustomCalendar />
                  </div>
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <h3 className="text-lg font-medium text-gray-800">Horaires disponibles*</h3>
                    </div>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Durée du rendez-vous*</label>
                    <select
                      name="duration"
                      required
                      className="w-full p-3 border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-gray-800 focus:border-gray-800 outline-none transition-all"
