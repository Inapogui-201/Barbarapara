      ...
      <div className="max-w-7xl mx-auto p-6 pt-32">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8">
            <h2 className="text-3xl font-light text-center mb-8 text-[#3a7ca5] ">
              Contactez-moi !
            </h2>
            <p className="text-gray-600 text-center mb-8">
              Pour toutes demandes de renseignements ou pour prendre
              rendez-vous, je me tiens à votre disposition grâce à ce
              formulaire, via Doctolib, par email et par téléphone.
            </p>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Psychologue et psychothérapeute clinicienne
                </p>
              </div>
